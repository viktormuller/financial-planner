...
export class SavingsAccount implements IncomeSource, HouseholdComponent{
private closingBalances:Map<number, MonetaryValue> = new Map<number, MonetaryValue>();
private interest: number = 0.02;

constructor(openingBalance?: MonetaryValue, pInterest: number =0.02, year = new Date().getFullYear()-1){
   this.closingBalances.set(year, openingBalance?openingBalance: {value:0, currency: CurrencyCode.GBP});
